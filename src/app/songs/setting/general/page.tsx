'use client'
import { EditeIconSvg, ListViewIconSvg, PlusBlackSvg, PorcentSvg, SquareIconList, UploadImageBrandIconSvg } from "@/assets/icons"
      ...
      >
       ...
       >
        ...
        >
          ...
          >
            <Typography variant="h9" color="text.secondary"> Supported formats include PNG, JPG and JPEG. Recommended resolution of 1080x1080 pixels. </Typography>
            <SecondaryButton
            text="Upload photo"
            height="43px"
            bgcolor="background.default"
